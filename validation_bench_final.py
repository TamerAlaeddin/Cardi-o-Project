...
class MainWindow:
    ...
    def patient_evaluation_gui(self, control):
        ...
        # CardioFeed button
        self.CFeedButton = CTkButton(root, text="Start CardioFeed", command=lambda: cardioFeed_check(), font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
        ...
        self.allMetrics = CTkButton(root, text="View All Metrics", command=lambda: show_plots(), font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
        self.allMetrics.grid(row=4, column=8, columnspan=3)

        # print to pdf button
        self.printPDF = CTkButton(root, text="Print to PDF", command=lambda: export_to_pdf(), font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
    ...
    def next_gui(self, control):
        ...
        self.button2 = CTkButton(root, text="Back", command=lambda: self.cardioFeed_gui(control), width=80, font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
    ...
    def cardioFeed_gui(self, control):
        ...
        # run button
        self.run_button = CTkButton(root, text="Run", command=lambda: self.threading(start_time_num.get(), duration_num.get(), control), width=80, font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
        ...
        self.backToEval = CTkButton(root, text="Back", command=lambda: self.patient_evaluation_gui(control),
                                 width=80, font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
    ...
    def select_files_gui(self):
        ...
        self.group_button = CTkButton(self.mid_frame, text="Add", command=lambda: add_patient(), width=80, font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
        self.group_button.grid(row=2, column=4)

        self.ungroup_button = CTkButton(self.mid_frame, text="Remove", command=lambda: remove_patient(), width=80, font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
        ...
        # back button
        self.backButton = CTkButton(self.bottom_frame, text="Back", command=lambda: self.root_gui(), font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
        ...
        self.evalAll = CTkButton(self.sub_bottom_frame, text="Evaluate All", command=lambda: group_to_list(0), font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
        self.evalAll.grid(row=0, column=0, padx=5)

        self.evalGroup = CTkButton(self.sub_bottom_frame, text="Evaluate Selection", command=lambda: group_to_list(1), font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
        self.evalGroup.grid(row=0, column=1, padx=5)

        self.clearGroupList = CTkButton(self.sub_bottom_frame, text="Clear Selection", command=lambda: clear_selection(), font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
    ...
    def root_gui(self):
        ...
        self.dirButton = CTkButton(root, text="Select Directory", command=lambda: directory_select(), font=("Arial", 16), fg_color="#1976D2", hover_color="#424242", corner_radius=5)
...
if __name__ == '__main__':
    ...
    root = tkb.Window(themename='darkly')   # flatly
